...
class Quiz
{
    public static int correct = 0; //correct
    public static int wrong = 0; //wrong
    public static int grade = 0; //grade

    public static void Main()
    //START
    {
        string[] choices = new string[5] {"a", "b", "c", "d", "e" };
        //Intro
        ...
        //Question 1
            ...
            if (Console.ReadLine() == choices[2]) //answer
            {
            CorrectAnsw();
            }
            else
        ...
        //Question 2
            ...
            if (Console.ReadLine() == choices[3]) //answer
            {
            CorrectAnsw();
            }
            else
        ...
        //Question 3
            ...
            if (Console.ReadLine() == choices[1]) //answer
            {
            CorrectAnsw();
            }
            else
        ...
        //Question 4
            ...
            if (Console.ReadLine() == choices[0]) //answer
            {
            CorrectAnsw();
            }
            else
        ...
        //Question 5
            ...
            if (Console.ReadLine() == choices[4]) //answer
            {
            CorrectAnsw();
            }
            else
